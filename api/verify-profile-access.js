/**
 * GET ?profile_access=<token> — returns { ok: true, email } or 403.
 */
...
module.exports = async function handler(req, res) {
  try {
    ...
    var q = req.query || {};
    var raw = q.profile_access;
    if (Array.isArray(raw)) raw = raw[0];
    var t = typeof raw === "string" ? raw : "";

    var verified = tokenLib.verifyProfileAccessToken(t);
    if (!verified.ok) {
    ...
    console.error("[verify-profile-access] fatal", fatal);
