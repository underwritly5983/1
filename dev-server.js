...
var earlyAccessHandler = require("./lib/api-handlers/early-access");
var profileRegistrationHandler = require("./lib/api-handlers/profile-registration");
var verifyHandler = require("./lib/api-handlers/verify");
var completeRegistrationHandler = require("./lib/api-handlers/complete-registration");
var sessionHandler = require("./lib/api-handlers/session");
var loginHandler = require("./lib/api-handlers/login");
var logoutHandler = require("./lib/api-handlers/logout");
var adminLoginHandler = require("./lib/api-handlers/admin-login");
var adminLogoutHandler = require("./lib/api-handlers/admin-logout");
var adminSessionHandler = require("./lib/api-handlers/admin-session");
var adminSubmissionsHandler = require("./lib/api-handlers/admin-submissions");
var healthHandler = require("./lib/api-handlers/health");
var teamHandler = require("./lib/api-handlers/team");
var completeSubBrokerHandler = require("./lib/api-handlers/complete-sub-broker");
