...
module.exports = async function handler(req, res) {
  try {
    ...
    if (profileLink) {
      registerBlurbText =
        "\n\nNext step — complete your broker profile (private link for this email only; do not forward):\n" +
        profileLink +
        "\n";
      registerBlurbHtml =
        ...
        "\" style=\"display:inline-block;padding:12px 20px;background:#059669;color:#ffffff;text-decoration:none;border-radius:10px;font-weight:600;\">Complete your profile</a></p>" +
    ...
    var confirmSubject = profileLink
      ? "Early access confirmed — complete your profile — Underwritly"
